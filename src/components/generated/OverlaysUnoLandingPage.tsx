...
const overlayCategories = [{
  ...
  active: true,
  mpid: "dac580d7-13f5-469c-8c70-75ffd0eb50a2"
}, {
  name: 'Browse Tools',
  active: false,
  mpid: "4519536e-1bb8-46f6-8742-6cf6675b1b65"
}] as any[];
const sportsOverlays = [{
  name: 'LPF Argentina Stadium Fly In',
  aspect: '16:9',
  mpid: "01ac0a9c-0eba-426c-a813-52bd125ef244"
}, {
  name: 'Basketball Stats Overlay',
  aspect: '16:9',
  mpid: "fc91f539-d50b-42a1-93f2-225e509a1fee"
}, {
  name: 'Football Scoreboard Pro',
  aspect: '16:9',
  mpid: "906ebac5-d7c8-40e7-b78c-67d9f4915399"
}, {
  name: 'Tennis Match Display',
  aspect: '16:9',
  mpid: "9d3acaac-ac68-4a51-a14c-df33ce0c89b5"
}, {
  name: 'Baseball Diamond View',
  aspect: '16:9',
  mpid: "0534c239-d02d-47d2-8433-74916bb68458"
}, {
  name: 'Hockey Rink Layout',
  aspect: '16:9',
  mpid: "4b2587d9-4638-4924-9eb3-fca14fdc0b62"
}] as any[];
const gamingOverlays = [{
  name: 'FPS Combat HUD',
  aspect: '16:9',
  mpid: "7762ec27-e157-4ae9-b3c1-a36638072c44"
}, {
  name: 'RPG Interface Pro',
  aspect: '16:9',
  mpid: "ed9cadb3-5f42-4301-8902-3b77a045f8cb"
}, {
  name: 'Racing Dashboard',
  aspect: '16:9',
  mpid: "bc5b81b8-60e7-4b75-ba45-8c480cf7ab6a"
}, {
  name: 'Strategy Command',
  aspect: '16:9',
  mpid: "24e18ccc-43bb-4e06-9a85-10ef2cc9f973"
}, {
  name: 'Battle Royale UI',
  aspect: '16:9',
  mpid: "d760bfec-f2d3-43ac-92f2-dee13ec7e05d"
}, {
  name: 'Retro Arcade Style',
  aspect: '16:9',
  mpid: "da703746-62ca-437a-b935-2ea8d43b91b8"
}] as any[];
const podcastOverlays = [{
  name: 'Talk Show Professional',
  aspect: '16:9',
  mpid: "1bd39b02-5d94-4abb-826c-62025bfcc8eb"
}, {
  name: 'Interview Setup Clean',
  aspect: '16:9',
  mpid: "02e890f2-1e1e-488d-877b-98ef3a8d894a"
}, {
  name: 'News Broadcast Modern',
  aspect: '16:9',
  mpid: "72b084f8-f82b-4769-9524-5f0531a6fb61"
}, {
  name: 'Panel Discussion Layout',
  aspect: '16:9',
  mpid: "4beca7e4-cacb-4e94-91bd-776de857ba40"
}, {
  name: 'Solo Cast Minimal',
  aspect: '16:9',
  mpid: "4530ef70-13be-4f35-859f-655ccb46b08a"
}, {
  name: 'Live Q&A Interactive',
  aspect: '16:9',
  mpid: "75b51f7a-831f-4070-a2eb-ee71845f2aa6"
}] as any[];
const howItWorksSteps = [{
  ...
  mpid: "61337fb2-5f5d-4f56-8973-4f5ccf1bd64d"
}, {
  icon: Palette,
  ...
  mpid: "fb007d2a-eca4-4f02-9b31-4f56eafa6bab"
}, {
  icon: Copy,
  ...
  mpid: "887db6e1-9f7a-42a7-8a6a-c6e2f19a6e3d"
}] as any[];
const stats = [{
  number: '19.8%',
  label: 'Higher Viewer Engagement',
  sublabel: '',
  mpid: "f6f0b214-ad54-418f-8ffa-e44b63162642"
}, {
  number: '3.2x',
  label: 'Higher Conversion Rates',
  sublabel: '',
  mpid: "4dbf9fcf-e173-4f93-a300-39f83e255d05"
}, {
  number: '47%',
  label: 'Fewer Technical Issues',
  sublabel: '',
  mpid: "e85ec4c9-d3ee-4b01-a082-7883709ca002"
}] as any[];
const communityCards = [{
  ...
  color: 'bg-indigo-600',
  mpid: "f5ee4d98-77ae-42dc-9827-2f403c42a423"
}, {
  icon: Youtube,
  ...
  buttonText: 'Follow',
  color: 'bg-red-600',
  mpid: "cd54eb6c-29ca-4e48-bcdd-3de5f1bff987"
}, {
  icon: Heart,
  title: 'Customize It',
  ...
  color: 'bg-pink-600',
  mpid: "65ad1325-eec7-473d-94eb-b71731d381d6"
}] as any[];
const navigationItems = [{
  label: 'Library',
  mpid: "2a4fc184-825f-42c8-8f46-1ab0ae9f27c7"
}, {
  label: 'Tools',
  mpid: "93f0f4c2-a6db-47e7-a156-98e211414bda"
}, {
  label: 'How It Works',
  mpid: "da34768b-bbaf-47ad-b167-9f59ad928274"
}, {
  label: 'Demo',
  mpid: "5f9c1fe6-6ebe-4204-8a4b-30397c8071fa"
}, {
  label: 'Live Breaks',
  mpid: "6965e709-5e09-4134-9b03-72d0db20e3b8"
}, {
  label: 'Shop',
  mpid: "824e5c89-67dd-4a31-97a0-ecb47c963dbb"
}, {
  label: 'About',
  mpid: "13b1170f-800a-4a60-ae3e-dcff091243ea"
}] as any[];
...
export const OverlaysUnoLandingPage = () => {
  ...
  const dotContent = [{
    ...
    mpid: "3b540863-c0c3-48c8-aa4b-c39fa6ded535"
  }, {
    id: 'dot-2',
    ...
    mpid: "0ecaadeb-a721-447d-a01a-b6ce3a5ff982"
  }, {
    id: 'dot-3',
    ...
    mpid: "d3eb6198-a150-4c12-b937-8c90056eed27"
  }] as const;
  ...
  const LayeredHeroButtons = () => {
    const cards = [{
      ...
      label: 'Form Window',
      z: 1,
      mpid: "008f9f1b-2dda-4238-a841-2303d0c526b8"
    }, {
      id: 'nfl-grid',
      label: 'NFL Grid',
      z: 2,
      mpid: "e7e9fd8a-c346-428e-b059-24bb6fd9d1ef"
    }, {
      id: 'phone-preview',
      label: 'Phone Preview',
      z: 3,
      mpid: "f26910d8-f148-4297-b309-8e434810ccd6"
    }] as any[];
    ...
    return <SortableContainer dndKitId="556d3a7b-d712-4f35-b742-018afa7c3e19" containerType="regular" prevTag="div" className="relative w-full h-full" data-magicpath-id="0" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        {/* Back layer – Browser Button */}
        <SortableContainer dndKitId="318a99a7-2bd3-4fc5-8b00-5ce343385cff" containerType="regular" prevTag="button" type="button" aria-label="Open form window" onClick={() => setSelectedHero('form')} className={`${baseStyles} form-window`} style={{
        ...
        transformStyle: 'preserve-3d'
          ...
          <SortableContainer dndKitId="f6d05f96-2f98-49c4-9404-7b2412385320" containerType="regular" prevTag="div" className="w-full h-full rounded-2xl bg-slate-900/80 border border-white/10 overflow-hidden" data-magicpath-id="2" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="28a85df9-b209-4855-b0ed-482393bad38a" containerType="regular" prevTag="div" className="flex items-center gap-2 px-4 py-2 border-b border-white/10" data-magicpath-id="3" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        ...
        <SortableContainer dndKitId="3652c09e-db26-4946-874e-1390f4ec530d" containerType="regular" prevTag="button" type="button" aria-label="Open NFL grid" onClick={() => setSelectedHero('nfl')} className={`${baseStyles} nfl-grid`} style={{
        ...
        <SortableContainer dndKitId="5e6fb461-0b61-42a7-9eee-12ddf63eb054" containerType="regular" prevTag="button" type="button" aria-label="Open phone preview" onClick={() => setSelectedHero('phone')} className={`${baseStyles} phone-preview`} style={{
        ...
        height: '72%'
          ...
          <SortableContainer dndKitId="7d20f994-2265-4290-835c-a25eecb33ef4" containerType="regular" prevTag="div" className="relative w-full h-full rounded-[14px] bg-black border border-white/20 p-2 shadow-[0_22px_60px_rgba(0,0,0,0.55)]" data-magicpath-id="12" data-magicpath-path="OverlaysUnoLandingPage.tsx">
  ...
  // @return
  return <SortableContainer dndKitId="b414be31-6e75-49e6-a67e-c88e9bbde596" containerType="regular" prevTag="div" className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-900 to-blue-950 text-white font-sans" data-magicpath-id="19" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      {/* Header */}
      <SortableContainer dndKitId="6d4c1630-4904-4317-9efa-59c0ccf22027" containerType="regular" prevTag="header" className="bg-slate-900/80 backdrop-blur-sm border-b border-orange-500/30 sticky top-0 z-50 flex flex-col md:flex-row items-center justify-between" data-magicpath-id="20" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="c2007dbd-98e3-4ad2-ab3c-69371a4a566f" containerType="regular" prevTag="div" className="w-full max-w-screen-xl mx-auto px-4 py-4" data-magicpath-id="21" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="239b3cb2-1bf1-4a70-ac98-09454df1a0dc" containerType="regular" prevTag="div" className="flex flex-col md:flex-row items-center justify-between w-full" data-magicpath-id="22" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            {/* Logo */}
            <SortableContainer dndKitId="771a63ae-7061-4eef-a82f-ce39a42e927d" containerType="regular" prevTag="div" className="text-2xl font-bold" data-magicpath-id="23" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            {/* Navigation */}
            <SortableContainer dndKitId="3c6b76a0-e075-429d-9eff-129bff1c601e" containerType="collection" prevTag="nav" className="hidden md:flex items-center space-x-8 -ml-8 lg:-ml-64" data-magicpath-id="26" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            {/* Auth & Discord */}
            <SortableContainer dndKitId="2e06c692-f89e-4aa3-8ad5-e6a834edeccb" containerType="regular" prevTag="div" className="flex items-center space-x-3" data-magicpath-id="30" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="c458716b-3648-468f-81c5-a3af98d72ce6" containerType="regular" prevTag="button" className="px-4 py-2 text-white border border-white rounded-full text-sm font-medium transition-colors duration-150 ease-out hover:bg-white hover:text-slate-900" data-magicpath-id="31" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="32" data-magicpath-path="OverlaysUnoLandingPage.tsx">Sign up</span>
              </SortableContainer>
              <SortableContainer dndKitId="8b6984cc-9785-45ef-8495-b0443dcd1058" containerType="regular" prevTag="button" className="px-4 py-2 text-white border border-white rounded-full text-sm font-medium transition-colors duration-150 ease-out hover:bg-white hover:text-slate-900" data-magicpath-id="33" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="34" data-magicpath-path="OverlaysUnoLandingPage.tsx">Login</span>
              </SortableContainer>
              <SortableContainer dndKitId="ea910fb4-60d3-483d-a6c7-d5647b248518" containerType="regular" prevTag="button" className="px-4 py-2 bg-[#FFC543] text-slate-900 border rounded-full text-sm font-medium transition-colors duration-150 ease-out hover:bg-white hover:text-[#FFC543] hover:border-white flex items-center space-x-2" data-magicpath-id="35" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Hero Section */}
      <SortableContainer dndKitId="23c3bc8e-1cfe-4d60-a803-a68a4fe11dbf" containerType="regular" prevTag="section" className="px-6 py-14" data-magicpath-id="38" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="f40c242c-a48d-4b50-b891-5bcfc555d633" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="39" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="e15a64a5-2866-495e-b567-39197f061a9a" containerType="regular" prevTag="div" className="grid lg:grid-cols-2 gap-16 items-center" data-magicpath-id="40" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="bfbcadcf-873e-4aa1-8d5b-63a57c22d5c6" containerType="regular" prevTag="motion.div" initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            duration: 0.8
              ...
              <SortableContainer dndKitId="3ac3352e-c19b-470e-94f2-eda037939245" containerType="regular" prevTag="motion.button" className="bg-gradient-to-r from-[#FF5C25] to-[#FFC542] bg-[length:200%_100%] bg-left hover:bg-right transition-all duration-300 ease-in-out px-10 py-4 rounded-full font-bold text-lg text-white focus:ring-2 focus:ring-yellow-400 focus:ring-offset-1 focus:outline-none shadow-lg" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            ...
            <SortableContainer dndKitId="b026d54b-e7bd-481c-b6a6-80b08701a913" containerType="regular" prevTag="motion.div" className="relative" initial={{
            opacity: 0,
            x: 30
          }} animate={{
            opacity: 1,
            ...
            delay: 0.2
              ...
              <SortableContainer dndKitId="6dca8e51-a36a-451a-a1b8-22f1a6359bcf" containerType="regular" prevTag="div" className="relative w-full h-full" data-magicpath-id="50" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="a2903e53-afce-450c-bc68-d307400415a0" containerType="regular" prevTag="div" className="relative w-full h-[420px] sm:h-[460px] md:h-[500px] lg:h-[520px] xl:h-[560px] rounded-3xl bg-gradient-to-br from-white/5 to-white/0 border border-white/10 p-6 sm:p-8" style={{
                perspective: 1200
              }} data-magicpath-id="51" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <SortableContainer dndKitId="cf83cb48-1f48-454d-8e8a-3400f424d0e6" containerType="regular" prevTag="div" className="relative w-full h-full" data-magicpath-id="52" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="123037fb-b2e8-4ef6-9522-26e598f5a67a" containerType="regular" prevTag="nav" aria-label="Hero pagination" className="mt-14 translate-y-5 flex items-center justify-center" data-magicpath-id="54" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="e16ece0b-37e2-4471-83f4-8e4c7a7d9aaa" containerType="collection" prevTag="ul" className="flex items-center gap-x-4" style={{
            display: "none"
      ...
      <SortableContainer dndKitId="63abd3da-1a81-4261-976d-55e467774b39" containerType="regular" prevTag="section" className="px-6 pt-12 pb-0 bg-black/20" data-magicpath-id="59" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="c09ffd7c-84df-4322-a371-185f16eec159" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="60" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="12b4f0ae-a569-46f6-b6be-dbf9f7600c2b" containerType="collection" prevTag="div" className="flex space-x-4 overflow-x-auto scrollbar-hide justify-center no-scrollbar snap-x snap-mandatory" data-magicpath-id="61" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="f948d47d-4f17-4113-a5d7-b2d7ecd3805d" containerType="regular" prevTag="section" className={`px-6 py-5 bg-black/20 ${activeCategory === 'Browse Tools' ? 'hidden' : ''}`} data-magicpath-id="65" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="f950aa7f-3b7f-44e1-ad98-6888b89fa344" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="66" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="fda054e5-9a6b-4c38-83c2-f113fdb94309" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="67" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="bbb86266-4178-4e03-984b-009549185389" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="70" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="7b686133-ae4f-4aa2-b789-95a5ece62b4c" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="71" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="7a122907-8bc4-4388-96b6-56ed6fe8e2bb" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="72" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="73" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="c8c7f8f3-93b4-49b9-8794-7624467ea6b4" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="74" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronRight className="w-5 h-5" data-magicpath-id="75" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
              </SortableContainer>
              <SortableContainer dndKitId="f33660e4-6458-4e29-990d-a9330088bba4" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-5" data-magicpath-id="76" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="8b494520-bd01-420e-9bb5-ebc180ca2874" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="79" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="b5ceab7c-dafa-457b-a8a2-224d0e712547" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="80" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="e4a0c142-9087-4b9f-8eee-1f2f120a1849" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="83" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="fa686f26-88bc-4d4d-b343-b343458496f7" containerType="regular" prevTag="section" className={`px-6 py-5 bg-black/20 ${activeCategory === 'Browse Tools' ? 'hidden' : ''}`} style={{
      paddingTop: 'calc(var(--spacing)*0)'
    }} data-magicpath-id="95" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="646a8f58-f767-4a5e-85ac-fce9e703a07b" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="96" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="ae76dfb1-4281-44d0-bde2-6df47b60a247" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="97" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="d0f939ea-aad8-4876-b2e4-ca8f949dab90" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="100" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="5f297af6-7d68-48ab-a6a4-60bce620f7a2" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="101" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="5c9b4c70-d1b8-4055-8c90-988129d52762" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="102" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="103" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="7c1c71a9-4bc2-424b-95b7-d1b59b92dab3" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="104" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronRight className="w-5 h-5" data-magicpath-id="105" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
              </SortableContainer>
              <SortableContainer dndKitId="2594b751-8233-462a-a3d7-2f9e00602740" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-5" data-magicpath-id="106" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="dfd12ed0-a833-44c1-950c-07b9d04cb6fc" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="109" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="542d7459-cc0a-4ec4-858c-8b4ee1992280" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="110" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="06625d99-171a-4163-aa53-d738c46b00b7" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="113" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="354958e4-dacc-4cb2-9d1a-f305a882e6d3" containerType="regular" prevTag="section" className={`px-6 py-5 bg-black/20 ${activeCategory === 'Browse Tools' ? 'hidden' : ''}`} style={{
      paddingBottom: 'calc(var(--spacing)*14)',
      paddingTop: 'calc(var(--spacing)*0)'
    }} data-magicpath-id="125" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="04fdcdff-7a3b-44a1-8cba-b973dacddfa7" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="126" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="2b02d1c6-6405-47e9-a509-7c482a80bc88" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="127" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="2e0a4004-f84b-44bd-9fec-a045a138a655" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="130" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="f90f8db5-7b69-472d-ab0d-c9ba65258365" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="131" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="889c6445-327e-4a4d-9cba-4e5688c55b42" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="132" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="133" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="4358576f-b4d8-4cd7-86ce-de00d80d51f5" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="134" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronRight className="w-5 h-5" data-magicpath-id="135" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
              </SortableContainer>
              <SortableContainer dndKitId="121f7443-4839-498f-92ec-86b4139558ec" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-5" data-magicpath-id="136" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="78ee3f90-9970-4ecf-9d49-1b17e47b396a" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="139" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="f6da010d-fb45-4e2b-8ff5-64eae6ed2005" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="140" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="c5405b53-abf9-46f7-a362-d86b5e5fa038" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="143" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="3758ae9c-015b-441f-81f2-55391a560b8c" containerType="regular" prevTag="section" className={`px-6 py-5 bg-black/20 ${activeCategory === 'Browse Tools' ? '' : 'hidden'}`} style={{
      paddingBottom: 'calc(var(--spacing)*14)'
    }} data-magicpath-id="155" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="f0cd4f02-29f1-43ab-8a67-47de8c09fa7e" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="156" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="dfe3a339-7356-4345-a04d-12eeefe07afd" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="157" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="d9b283b9-19ba-4dcb-b2e6-d7861f985202" containerType="regular" prevTag="div" className="flex items-center" data-magicpath-id="160" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="a13344f1-c52b-4bb7-8c20-3845425357bb" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="161" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="c0867fa7-0a44-4b2c-a332-4bb7043c280c" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="162" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="163" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="b13d1ab3-f60e-464a-8e24-b96d2a0c8c0e" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10 ml-3" data-magicpath-id="164" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="65a6738d-d3f1-4764-92ee-45f7a1f0e431" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="166" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="b28d51ef-97e8-499c-bb79-c1580b0c504e" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="167" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="c75c8e03-d26c-45e1-a046-52351588169a" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="170" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Feature Panel */}
      <SortableContainer dndKitId="fe8c6762-7c7e-4edd-b5cd-025f0e07aa99" containerType="regular" prevTag="section" className="px-6 py-24" style={{
      paddingBlock: 'calc(var(--spacing)*14)'
    }} data-magicpath-id="183" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="30c772dc-c031-4fec-82ca-383d4a663aa4" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="184" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="e9f594d6-b11a-47aa-802d-ff968cc808f7" containerType="regular" prevTag="div" className="grid lg:grid-cols-2 gap-16 items-center" data-magicpath-id="185" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="31640935-4e26-4009-a134-4e1a7451586f" containerType="regular" prevTag="div" className="space-y-8" data-magicpath-id="186" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="451236d3-2053-4a98-a07c-6e2810f30923" containerType="regular" prevTag="button" className="bg-gradient-to-r from-[#FF5C25] to-[#FFC542] bg-[length:200%_100%] bg-left hover:bg-right transition-all duration-300 ease-in-out px-6 py-2 rounded-full font-bold text-base lg:text-lg text-white focus:ring-2 focus:ring-yellow-400 focus:ring-offset-1 focus:outline-none" data-magicpath-id="192" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="193" data-magicpath-path="OverlaysUnoLandingPage.tsx">Learn More</span>
              </SortableContainer>
            </SortableContainer>
            <SortableContainer dndKitId="8dc5c535-e5a4-43e7-9451-8645a599a090" containerType="regular" prevTag="div" className="bg-gradient-to-br from-purple-800/20 to-blue-800/20 rounded-3xl p-12 flex items-center justify-center border border-white/10" data-magicpath-id="194" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="4a8e0c36-36d3-4142-814c-65a9e39203b9" containerType="regular" prevTag="div" className="text-center space-y-6" data-magicpath-id="195" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="18944d61-32fd-4c88-a124-2299b26bc567" containerType="regular" prevTag="div" className="w-24 h-24 bg-orange-500/20 rounded-2xl mx-auto flex items-center justify-center" data-magicpath-id="196" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* How It Works */}
      <SortableContainer dndKitId="933f02d6-3f12-4371-a735-0c7b9c53a1df" containerType="regular" prevTag="section" className="px-6 py-24 bg-black/20" data-magicpath-id="200" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="45d2a496-c181-4d1d-96cd-6b0914437ad8" containerType="regular" prevTag="div" className="max-w-7xl mx-auto text-center" data-magicpath-id="201" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="5621b8e7-1d5c-4bc3-a6a3-feda14698456" containerType="collection" prevTag="div" className="grid md:grid-cols-3 gap-12" data-magicpath-id="206" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Pricing */}
      <SortableContainer dndKitId="68901e21-5ae9-47ac-acb5-200d728f860c" containerType="regular" prevTag="section" className="px-6 py-24" data-magicpath-id="216" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="5302dc17-531c-4153-993b-14b6f476d242" containerType="regular" prevTag="div" className="max-w-5xl mx-auto text-center" data-magicpath-id="217" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="ab06ba1d-c70b-499f-acbf-80d8bbcdfba5" containerType="regular" prevTag="div" className="flex items-center justify-center mb-16" data-magicpath-id="222" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="a89f2334-44b7-4ab8-b112-b2de40fd037c" containerType="regular" prevTag="div" className="bg-slate-800/50 rounded-xl p-2 border border-slate-700/50" data-magicpath-id="223" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="8daa42c8-0b0e-4b54-9bc0-5ea70cad9846" containerType="regular" prevTag="button" onClick={() => setPricingToggle('monthly')} className={`px-8 py-3 rounded-lg transition-all font-medium ${pricingToggle === 'monthly' ? 'bg-orange-500 text-white shadow-lg' : 'text-gray-300 hover:text-white'}`} data-magicpath-id="224" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="225" data-magicpath-path="OverlaysUnoLandingPage.tsx">Monthly</span>
              </SortableContainer>
              <SortableContainer dndKitId="18ba4300-2a60-4dde-9872-d85901eba32f" containerType="regular" prevTag="button" onClick={() => setPricingToggle('yearly')} className={`px-8 py-3 rounded-lg transition-all font-medium ${pricingToggle === 'yearly' ? 'bg-orange-500 text-white shadow-lg' : 'text-gray-300 hover:text-white'}`} data-magicpath-id="226" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="227" data-magicpath-path="OverlaysUnoLandingPage.tsx">Yearly</span>
              </SortableContainer>
            </SortableContainer>
          </SortableContainer>

          <SortableContainer dndKitId="874042bf-4623-479c-8309-21f777aa689a" containerType="regular" prevTag="div" className="grid md:grid-cols-2 gap-8" data-magicpath-id="228" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            {/* Free Plan */}
            <SortableContainer dndKitId="169072f5-4b6f-4dde-9532-6f64c5289d8c" containerType="regular" prevTag="div" className="bg-white/10 rounded-3xl p-10 border border-white/10" data-magicpath-id="229" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="7de78746-0fa0-44d3-b2d6-40c95b9fe692" containerType="regular" prevTag="div" className="text-5xl font-bold mb-8" data-magicpath-id="234" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="235" data-magicpath-path="OverlaysUnoLandingPage.tsx">$0.00</span>
              </SortableContainer>
              <SortableContainer dndKitId="b7e472e1-08ca-45ae-89c5-67c6a39791e8" containerType="regular" prevTag="ul" className="space-y-4 mb-10 text-left" data-magicpath-id="236" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="861f3540-8cbd-4ace-a2a7-703eeb96a5db" containerType="regular" prevTag="button" className="w-full py-4 bg-slate-600 text-gray-300 rounded-xl font-semibold text-lg" data-magicpath-id="249" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="250" data-magicpath-path="OverlaysUnoLandingPage.tsx">Current Plan</span>
              </SortableContainer>
            </SortableContainer>

            {/* Plus Plan */}
            <SortableContainer dndKitId="68b711e7-1b0e-4899-9135-932ecddd5115" containerType="regular" prevTag="div" className="bg-white/10 rounded-3xl p-10 border border-orange-500/30 relative" data-magicpath-id="251" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              {pricingToggle === 'yearly' && <SortableContainer dndKitId="bd76d1c9-e179-4847-a549-cde090bed52f" containerType="regular" prevTag="div" className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-orange-500 text-white px-6 py-2 rounded-full text-sm font-semibold" data-magicpath-id="252" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="5f0fe88d-d64e-4b6c-853c-54622abfeb8e" containerType="regular" prevTag="div" className="text-5xl font-bold mb-8" data-magicpath-id="258" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="3cdbe12e-b8fa-4231-a8b5-7d1d321fa733" containerType="regular" prevTag="ul" className="space-y-4 mb-10 text-left" data-magicpath-id="261" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="317509fb-2eca-4d2d-a23b-8f5cdd59e7b5" containerType="regular" prevTag="button" className="w-full py-4 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-semibold text-lg transition-colors" data-magicpath-id="274" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Stats */}
      <SortableContainer dndKitId="40bd619f-6a37-431f-b8af-f0c673245a26" containerType="regular" prevTag="section" className="px-6 py-24 bg-black/20" data-magicpath-id="276" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="b730e541-2c8d-45fa-acdc-e9245cfe9e2b" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="277" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="f8fa4ddf-7143-4cd5-ace6-3612cce0062b" containerType="collection" prevTag="div" className="grid md:grid-cols-3 gap-8" onMouseLeave={e => {
      ...
      {/* Community CTAs */}
      <SortableContainer dndKitId="3bad9f72-788b-427a-827e-e9aa60e2423a" containerType="regular" prevTag="section" className="px-6 py-24" data-magicpath-id="292" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="cf48f6c4-34a0-43e4-aff9-29879ff87663" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="293" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="c6a01744-27e3-400f-a014-643c4b7dc2b6" containerType="collection" prevTag="div" className="grid md:grid-cols-3 gap-8" data-magicpath-id="296" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Section Divider */}
      <div className="w-full h-px bg-gradient-to-r from-transparent via-white/20 to-transparent" data-magicpath-id="310" data-magicpath-path="OverlaysUnoLandingPage.tsx"></div>

      {/* Footer */}
      <SortableContainer dndKitId="6e39a97a-bb39-4a0d-9d1a-602a990fa3c5" containerType="regular" prevTag="footer" className="px-6 py-16" data-magicpath-id="311" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="e331d65c-ff1d-47bc-b425-a759e739b2f9" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="312" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="83599981-6300-4c77-8ce4-6b374c6402a0" containerType="regular" prevTag="div" className="flex items-center justify-between" data-magicpath-id="313" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="7987d590-c2a7-42d1-8e92-22c174b42bef" containerType="regular" prevTag="div" className="text-2xl font-bold" data-magicpath-id="314" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <span className="text-orange-500" data-magicpath-id="315" data-magicpath-path="OverlaysUnoLandingPage.tsx">overlays.</span>
              <span className="text-white" data-magicpath-id="316" data-magicpath-path="OverlaysUnoLandingPage.tsx">uno</span>
            </SortableContainer>
            <SortableContainer dndKitId="aace76c1-7962-4a7f-91fe-de0caa23bcc7" containerType="regular" prevTag="div" className="flex items-center space-x-8" data-magicpath-id="317" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <a href="#" className="text-gray-400 hover:text-white transition-colors font-medium" data-magicpath-id="318" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="319" data-magicpath-path="OverlaysUnoLandingPage.tsx">Privacy Policy</span>
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors font-medium" data-magicpath-id="320" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="321" data-magicpath-path="OverlaysUnoLandingPage.tsx">Terms</span>
              </a>
            </SortableContainer>
          </SortableContainer>
        </SortableContainer>
