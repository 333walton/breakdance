...
const overlayCategories = [{
  ...
  active: true,
  mpid: "75efba26-6faf-47f2-9564-73613c524743"
}, {
  name: 'Browse Tools',
  active: false,
  mpid: "e3d82884-10f8-4128-8651-b37e2a9dcfa8"
}] as any[];
const sportsOverlays = [{
  name: 'LPF Argentina Stadium Fly In',
  aspect: '16:9',
  mpid: "e1a77922-e0a5-41fb-8be4-2aa98a18cbf4"
}, {
  name: 'Basketball Stats Overlay',
  aspect: '16:9',
  mpid: "80a46db6-11ed-4b3e-ab5e-589df63fd953"
}, {
  name: 'Football Scoreboard Pro',
  aspect: '16:9',
  mpid: "8850cc9d-ddcb-41f5-862e-b8c41b3e8c2b"
}, {
  name: 'Tennis Match Display',
  aspect: '16:9',
  mpid: "3f6f2afb-bac2-4ee6-b0c4-5bae7e0ad2b0"
}, {
  name: 'Baseball Diamond View',
  aspect: '16:9',
  mpid: "2612e856-0644-4400-8c5c-8d82d24f8871"
}, {
  name: 'Hockey Rink Layout',
  aspect: '16:9',
  mpid: "0592812d-190b-4ea9-aa59-5784a07075fc"
}] as any[];
const gamingOverlays = [{
  name: 'FPS Combat HUD',
  aspect: '16:9',
  mpid: "420318c8-e9da-4561-95ae-02d8f23c464c"
}, {
  name: 'RPG Interface Pro',
  aspect: '16:9',
  mpid: "5de4a1c8-80ed-4c2f-8e83-f099acfd21aa"
}, {
  name: 'Racing Dashboard',
  aspect: '16:9',
  mpid: "f94ddf87-c5d4-453d-9c6b-a09200b4afed"
}, {
  name: 'Strategy Command',
  aspect: '16:9',
  mpid: "25c55087-a328-494e-81e4-8dd69c265137"
}, {
  name: 'Battle Royale UI',
  aspect: '16:9',
  mpid: "1d351ef7-4658-46d0-b7e7-1face091987c"
}, {
  name: 'Retro Arcade Style',
  aspect: '16:9',
  mpid: "ffe6c3eb-e543-4a53-bb82-cd5c6aa5f6e3"
}] as any[];
const podcastOverlays = [{
  name: 'Talk Show Professional',
  aspect: '16:9',
  mpid: "6b69b152-f9af-4432-a53e-7cf3c36a478f"
}, {
  name: 'Interview Setup Clean',
  aspect: '16:9',
  mpid: "7bdca2c1-413b-4286-b7bd-700f700c843c"
}, {
  name: 'News Broadcast Modern',
  aspect: '16:9',
  mpid: "a168aead-de7b-47da-bad7-f29f3862be4f"
}, {
  name: 'Panel Discussion Layout',
  aspect: '16:9',
  mpid: "254db193-6d2b-4764-80b4-cceaee20d0d8"
}, {
  name: 'Solo Cast Minimal',
  aspect: '16:9',
  mpid: "2867df1b-5d92-436e-9a69-e955250b1d44"
}, {
  name: 'Live Q&A Interactive',
  aspect: '16:9',
  mpid: "4fe84774-b6da-4ec9-931e-6484c8f1e80a"
}] as any[];
const howItWorksSteps = [{
  ...
  mpid: "288dea47-c40c-44a1-9fc5-956815323e9d"
}, {
  icon: Palette,
  ...
  mpid: "d6598df2-edb8-4621-9cf2-7bcbf581e2a0"
}, {
  icon: Copy,
  ...
  mpid: "80e698ca-c739-447d-98f8-d85ccfd01c45"
}] as any[];
const stats = [{
  number: '19.8%',
  label: 'Higher Viewer Engagement',
  sublabel: '',
  mpid: "8d6d3aff-b308-49cb-9995-54c77e03b62d"
}, {
  number: '3.2x',
  label: 'Higher Conversion Rates',
  sublabel: '',
  mpid: "69adb81f-8031-417d-b3c3-81e435b7e132"
}, {
  number: '47%',
  label: 'Fewer Technical Issues',
  sublabel: '',
  mpid: "0305cd27-1836-49a4-9e9a-792d201b8213"
}] as any[];
const communityCards = [{
  ...
  mpid: "d42b68f5-10b0-407e-903e-42318c644a2e"
}, {
  icon: Youtube,
  ...
  mpid: "0051a738-0258-4a05-a5d8-91a018e5a11e"
}, {
  icon: Heart,
  title: 'Customize It',
  ...
  mpid: "2adabd2f-0d47-4d4e-b641-be4aaa232f3b"
}] as any[];
const navigationItems = [{
  label: 'Library',
  mpid: "d45f4b7e-f659-4f5e-bf02-da89e5e4844e"
}, {
  label: 'Tools',
  mpid: "da14ecbf-5f9b-486b-b66f-576955cf16c5"
}, {
  label: 'How It Works',
  mpid: "b78d1338-0cfa-4b93-835f-d5d62882a3ee"
}, {
  label: 'Demo',
  mpid: "d363699d-f60c-4849-8f9f-4c31b943b3bc"
}, {
  label: 'Live Breaks',
  mpid: "835d5a12-c727-4d54-b17f-4c88c7b9eb31"
}, {
  label: 'Shop',
  mpid: "dd497fca-6abd-4a42-a268-94948704ab53"
}, {
  label: 'About',
  mpid: "b6dd9a96-8515-48cf-aa59-c95b28cd0cdf"
}] as any[];
...
export const OverlaysUnoLandingPage = () => {
  ...
  const dotContent = [{
    ...
    mpid: "56ca92b9-c8f3-4d7e-bfca-d4a72b365f22"
  }, {
    id: 'dot-2',
    ...
    mpid: "f0f8c66b-ae8f-4cda-8280-4c5e7dfe7f6e"
  }, {
    id: 'dot-3',
    ...
    mpid: "30e5667d-3720-4cc3-9149-1a6119f5cacf"
  }] as const;
  ...
  const LayeredHeroButtons = () => {
    const cards = [{
      ...
      label: 'Form Window',
      z: 1,
      mpid: "d8eeee7d-be81-4142-8c21-63baa46293d6"
    }, {
      id: 'nfl-grid',
      label: 'NFL Grid',
      z: 2,
      mpid: "a37ef897-3521-4784-ba74-385f271d2c76"
    }, {
      id: 'phone-preview',
      label: 'Phone Preview',
      z: 3,
      mpid: "9bc378da-73be-4b4b-88db-ba5d4e04a28e"
    }] as any[];
    ...
    return <SortableContainer dndKitId="f3698ae9-f586-47c3-82db-38f18e9bfae0" containerType="regular" prevTag="div" className="relative w-full h-full" data-magicpath-id="0" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        {/* Back layer – Browser Button */}
        <SortableContainer dndKitId="7250bb8d-225d-4722-89c6-acf0368a1e46" containerType="regular" prevTag="button" type="button" aria-label="Open form window" onClick={() => bringToFront('form')} className={`${baseStyles} form-window transition-opacity duration-300 ${nflFocused ? 'opacity-0 pointer-events-none' : 'opacity-100'} transition-[transform,filter,box-shadow,background-color,border-color] duration-500 ease-in-out hover:bg-white/10 hover:shadow-lg hover:border-white/20`} style={{
        ...
        if (!nflFocused) {
          ...
          <SortableContainer dndKitId="16d07818-f036-47a2-8b04-4a840bd383eb" containerType="regular" prevTag="div" className="w-full h-full rounded-2xl bg-slate-900/80 border border-white/10 overflow-hidden" data-magicpath-id="2" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="583ddf75-13b5-4db9-b6bf-97dc7ed55965" containerType="regular" prevTag="div" className="flex items-center gap-2 px-4 py-2 border-b border-white/10" data-magicpath-id="3" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        ...
        <SortableContainer dndKitId="c087eb65-7d84-4d50-9d18-551da7023d23" containerType="regular" prevTag="button" type="button" aria-label="Open NFL grid" onClick={() => bringToFront('nfl')} className={`${baseStyles} nfl-grid transition-[transform,opacity,left,top,filter,box-shadow,background-color,border-color] duration-500 ease-in-out hover:bg-white/10 hover:shadow-lg hover:border-white/20`} style={{
        ...
        <SortableContainer dndKitId="2c8986c5-8fd9-4de5-8025-1cb744c2b1ca" containerType="regular" prevTag="button" type="button" aria-label="Open phone preview" onClick={() => bringToFront('phone')} className={`${baseStyles} phone-preview transition-opacity duration-300 ${nflFocused ? 'opacity-0 pointer-events-none' : 'opacity-100'} transition-[transform,filter,box-shadow,background-color,border-color] duration-500 ease-in-out hover:bg-white/10 hover:shadow-lg hover:border-white/20`} style={{
        ...
        if (!nflFocused) {
          ...
          <SortableContainer dndKitId="89498392-7caa-49d9-8ac3-448b2fd95f60" containerType="regular" prevTag="div" className="relative w-full h-full rounded-[14px] bg-black border border-white/20 p-2 shadow-[0_22px_60px_rgba(0,0,0,0.55)]" data-magicpath-id="12" data-magicpath-path="OverlaysUnoLandingPage.tsx">
  ...
  // @return
  return <SortableContainer dndKitId="94f90bd7-5513-44b2-a5be-41ef32c7b3e1" containerType="regular" prevTag="div" className="min-h-screen bg-gradient-to-b from-[#1F1A30] via-[#582864] to-[#9149c1] text-white font-sans" data-magicpath-id="19" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      {/* Header */}
      <SortableContainer dndKitId="5fac9383-3d61-4613-8349-c4c2adbf2329" containerType="regular" prevTag="header" className="bg-gradient-to-b from-[#26213a] to-[#302742] backdrop-blur-sm border-b border-orange-500/30 sticky top-0 z-50 flex flex-col md:flex-row items-center justify-between" data-magicpath-id="20" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="69902e91-db68-4b59-9b74-7f937f04ab4b" containerType="regular" prevTag="div" className="w-full max-w-screen-xl mx-auto px-4 py-4" data-magicpath-id="21" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="c4e69922-c323-4320-8616-1680e568da52" containerType="regular" prevTag="div" className="flex flex-col md:flex-row items-center justify-between w-full" data-magicpath-id="22" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            {/* Logo */}
            <SortableContainer dndKitId="98361a01-96f2-418a-95f5-78eecd5fff3c" containerType="regular" prevTag="div" className="text-2xl font-bold" data-magicpath-id="23" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            {/* Navigation */}
            <SortableContainer dndKitId="828cf5a1-48f9-4e57-8285-8711b75cfbbd" containerType="collection" prevTag="nav" className="hidden md:flex items-center space-x-8 -ml-8 lg:-ml-64" data-magicpath-id="26" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            {/* Auth & Discord */}
            <SortableContainer dndKitId="b86e7a1d-3d3a-4b89-86ec-f115c229745e" containerType="regular" prevTag="div" className="flex items-center space-x-3" data-magicpath-id="30" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="409bec2a-0a8d-4981-aefe-df27e4f5f394" containerType="regular" prevTag="button" className="px-4 py-2 text-white border border-white/20 rounded-full text-sm font-medium transition-colors duration-150 ease-out hover:bg-white hover:text-slate-900" data-magicpath-id="31" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="32" data-magicpath-path="OverlaysUnoLandingPage.tsx">Sign up</span>
              </SortableContainer>
              <SortableContainer dndKitId="1b41fa27-3216-4a0e-b728-fb9a282c978e" containerType="regular" prevTag="button" className="px-4 py-2 text-white border border-white/20 rounded-full text-sm font-medium transition-colors duration-150 ease-out hover:bg-white hover:text-slate-900" data-magicpath-id="33" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="34" data-magicpath-path="OverlaysUnoLandingPage.tsx">Login</span>
              </SortableContainer>
              <SortableContainer dndKitId="631197fa-058e-4144-9d61-dc5716ea216d" containerType="regular" prevTag="button" className="px-4 py-2 bg-[#FFC543] text-slate-900 border rounded-full text-sm font-medium transition-colors duration-150 ease-out hover:bg-white hover:text-[#FFC543] hover:border-white flex items-center space-x-2" data-magicpath-id="35" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Hero Section */}
      <SortableContainer dndKitId="2632a237-1deb-4889-b7a3-d265ebcd5f4e" containerType="regular" prevTag="section" className="relative px-6 py-14" data-magicpath-id="38" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        ...
        <SortableContainer dndKitId="f1589523-d7b4-4d0d-b522-5ab7c39db5f3" containerType="regular" prevTag="div" className="relative z-10 max-w-7xl mx-auto" data-magicpath-id="41" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="cb35b38e-8b5c-45dd-af99-2da843aebaea" containerType="regular" prevTag="div" className="grid lg:grid-cols-2 gap-16 items-center min-h-[420px] md:min-h-[520px] lg:min-h-[560px]" data-magicpath-id="42" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="56f4f577-85c8-4908-979b-42af64406cc5" containerType="regular" prevTag="motion.div" initial="hidden" whileInView="show" viewport={{
            once: true,
            amount: 0.3
              ...
              <SortableContainer dndKitId="2c45fc8c-3da9-49a9-a7dc-fe0e52e8dcf7" containerType="regular" prevTag="motion.button" className="bg-gradient-to-r from-[#FF5C25] to-[#FFC542] bg-[length:200%_100%] bg-left hover:bg-right transition-all duration-300 ease-in-out px-10 py-4 rounded-full font-bold text-lg text-white focus:ring-2 focus:ring-yellow-400 focus:ring-offset-1 focus:outline-none shadow-lg" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            ...
            <SortableContainer dndKitId="5ecb64ba-22b1-4ef0-ae74-5aa018e09e00" containerType="regular" prevTag="motion.div" className="relative" initial="hidden" whileInView="show" viewport={{
            once: true,
            amount: 0.3
          }} variants={fadeRise} data-magicpath-id="51" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="2f745a6c-bc4b-4585-8290-f7319959423d" containerType="regular" prevTag="div" className="relative w-full h-full" data-magicpath-id="52" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="38da4d63-7eb7-4c80-9f28-cdbcd4b97824" containerType="regular" prevTag="div" className="relative w-full h-[420px] sm:h-[460px] md:h-[500px] lg:h-[520px] xl:h-[560px] rounded-3xl bg-gradient-to-b from-[#26213a]/60 to-[#302742]/40 border border-white/10 p-6 sm:p-8" style={{
                perspective: 1200
              }} data-magicpath-id="53" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <SortableContainer dndKitId="38816e96-9269-48dc-8798-0bd34a19ecd9" containerType="regular" prevTag="div" className="relative w-full h-full" data-magicpath-id="54" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                    {/* Layered feature buttons container */}
                    <SortableContainer dndKitId="3c0041a9-6801-4138-8487-1578aa0c97c4" containerType="regular" prevTag="div" ref={heroStageRef} className="relative w-full h-full" data-magicpath-id="55" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                      {/* Back layer – Browser Button */}
                      <SortableContainer dndKitId="0279215c-0a71-4456-b9a5-a4106bbb213e" containerType="regular" prevTag="button" type="button" aria-label="Open form window" onClick={() => {
                      setNflFocused(false);
                      ...
                      if (!nflFocused) {
                        ...
                        <SortableContainer dndKitId="c61c8b87-2862-46b0-9e6f-02212bf72b51" containerType="regular" prevTag="div" className="w-full h-full rounded-2xl bg-slate-900/80 border border-white/10 overflow-hidden" data-magicpath-id="57" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                          <SortableContainer dndKitId="5b81f98e-eff8-4dd3-85b4-7b63fd085013" containerType="regular" prevTag="div" className="flex items-center gap-2 px-4 py-2 border-b border-white/10" data-magicpath-id="58" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                      ...
                      {/* Middle layer – Grid Button */}
                      <SortableContainer dndKitId="ccb5c331-19f3-4e8b-8783-9cfc78031c09" containerType="regular" prevTag="button" type="button" aria-label="Open NFL grid" onClick={() => {
                      ...
                      {/* Front layer – Phone Button */}
                      <SortableContainer dndKitId="49eb9527-2102-4b67-bf59-e6da10f290ea" containerType="regular" prevTag="button" type="button" aria-label="Open phone preview" onClick={() => {
                      setNflFocused(false);
                      ...
                      if (!nflFocused) {
                        ...
                        <SortableContainer dndKitId="eb675920-0289-403b-a4d2-7655444ccd6d" containerType="regular" prevTag="div" className="relative w-full h-full rounded-[14px] bg-black border border-white/20 p-2 shadow-[0_22px_60px_rgba(0,0,0,0.55)]" data-magicpath-id="67" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                      ...
                      {selectedHero === 'nfl' ? <SortableContainer dndKitId="8cbc837a-cb9e-45a9-9c8f-3c231c1f718e" containerType="regular" prevTag="div" className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2" data-magicpath-id="73" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                          <span className="inline-block h-2.5 w-2.5 rounded-full bg-white/40" data-magicpath-id="74" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                          <span className="inline-block h-2.5 w-2.5 rounded-full bg-white/40" data-magicpath-id="75" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                          <span className="inline-block h-2.5 w-2.5 rounded-full bg-white/40" data-magicpath-id="76" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
          ...
          <SortableContainer dndKitId="7718013c-51ab-4a68-9c1d-f9bb0529b7b0" containerType="regular" prevTag="nav" aria-label="Hero pagination" className="mt-14 translate-y-5 flex items-center justify-center" data-magicpath-id="77" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="348330ae-1abc-4f5a-a206-bbdb8bfe3f04" containerType="collection" prevTag="ul" className="flex items-center gap-x-4" style={{
            display: "none"
      ...
      <SortableContainer dndKitId="21e506ec-90e6-4651-a1e1-d835285287b4" containerType="regular" prevTag="section" className="px-6 pt-12 pb-0 bg-gradient-to-b from-[#222032] to-[#2a2338]" data-magicpath-id="82" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="b9f5fbc7-0f1a-4043-8beb-0e3c85c98057" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="83" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="3cdcd9bc-6638-451a-ac16-dcf7f0b9c575" containerType="collection" prevTag="div" className="flex space-x-4 overflow-x-auto scrollbar-hide justify-center no-scrollbar snap-x snap-mandatory" data-magicpath-id="84" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="a0f92e76-d00e-4e52-b6cf-aa0ebf5b8177" containerType="regular" prevTag="section" className={`px-6 py-5 bg-gradient-to-b from-[#222032] to-[#2a2338] ${activeCategory === 'Browse Tools' ? 'hidden' : ''}`} data-magicpath-id="88" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="d84ca753-24ff-41af-855a-53ef4bebc78f" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="89" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="6ab6baac-7a99-4285-a948-e592fd276013" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="90" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="1b1d34ff-0931-4816-a013-ebc3e2e6d12e" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="93" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="2e64617b-05db-44b2-989c-45511e7cb37e" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="94" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="52edd4f5-e243-4e7a-84de-cd969acf0a6d" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="95" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="96" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="0f5feccc-64c6-45f3-bcf6-cf9b3d6dda51" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="97" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronRight className="w-5 h-5" data-magicpath-id="98" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
              </SortableContainer>
              <SortableContainer dndKitId="9013cb8a-5608-4038-b39c-322c438ce9c2" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-5" data-magicpath-id="99" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="19864ad9-8c71-4aa7-a765-f08e31eff450" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="102" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="f1aeceee-0b7f-4153-9e60-76682d80a344" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="103" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="618b6416-dd24-4f72-8f77-d8eeaed41a19" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="106" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="69de5573-c768-482a-9f5e-54b3317d43b3" containerType="regular" prevTag="section" className={`px-6 py-5 bg-gradient-to-b from-[#2a2338] to-[#2b253e] ${activeCategory === 'Browse Tools' ? 'hidden' : ''}`} style={{
      paddingTop: 'calc(var(--spacing)*0)'
    }} data-magicpath-id="118" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="a38b8940-7834-45e3-92d5-40393554bd52" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="119" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="5c134b78-d632-4a52-ba2a-314a57377ab1" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="120" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="1fa0120b-407e-4c95-8a8f-60a725923b5b" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="123" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="5d50461f-d46b-4489-9634-b0357127b9be" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="124" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="a38c3a5f-174b-4140-967f-206b88bc5b58" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="125" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="126" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="ccc70218-9d06-422a-85f1-422ced04a5c8" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="127" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronRight className="w-5 h-5" data-magicpath-id="128" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
              </SortableContainer>
              <SortableContainer dndKitId="b7a8f1d2-51f7-4964-8ff4-2615d93c9a5e" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-5" data-magicpath-id="129" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="072486e7-1ccb-46ed-8efd-9f7cff37920e" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="132" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="8f7ec7d1-e980-428e-a256-483e201261ac" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="133" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="e9123293-de37-4f9d-9a2f-075e60b625d2" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="136" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="ef452991-55e0-48b1-a084-7ce263b1ee84" containerType="regular" prevTag="section" className={`px-6 py-5 bg-gradient-to-b from-[#2b233e] to-[#302742] ${activeCategory === 'Browse Tools' ? 'hidden' : ''}`} style={{
      paddingBottom: 'calc(var(--spacing)*14)',
      paddingTop: 'calc(var(--spacing)*0)'
    }} data-magicpath-id="148" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="a8c0a275-0622-4d96-a7f7-9f6bdf519333" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="149" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="301919af-5cc4-483b-8175-fd3870a33fd6" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="150" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="ebf3bc92-1dab-4aa0-bf5b-7b22086c9777" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="153" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="ed6ea8e5-26f5-44a1-82e4-4328ace103e4" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="154" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="b5a2c49a-850d-4388-b56e-007ba4bf959d" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="155" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="156" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="7072cd2e-12c7-4e1d-9d86-7bcc45121e8e" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="157" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronRight className="w-5 h-5" data-magicpath-id="158" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
              </SortableContainer>
              <SortableContainer dndKitId="2261d6e2-87bb-4749-af4b-70d5c896260a" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-5" data-magicpath-id="159" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="c760c867-85a7-4b6b-a243-8b5e8ec135f5" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="162" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="3890fba7-464a-475d-9b2d-419b3656d5a6" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="163" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="0b0153fd-eabe-4a91-85ef-2d3a03b5ef58" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="166" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="c327ac99-2988-48dc-bfa2-218a071acab5" containerType="regular" prevTag="section" className={`px-6 py-5 bg-gradient-to-b from-[#222032] to-[#2a2338] ${activeCategory === 'Browse Tools' ? '' : 'hidden'}`} style={{
      paddingBottom: 'calc(var(--spacing)*14)'
    }} data-magicpath-id="178" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="3e168414-7d66-4100-91ab-9ee035764e16" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="179" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="14937a9c-04cf-4d62-9bfc-eec604a710ef" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="180" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="cd66bf5e-a3fc-43aa-8104-451c6dca1f89" containerType="regular" prevTag="div" className="flex items-center" data-magicpath-id="183" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="c5dfd18a-01cc-47d8-8876-1aadb85cf115" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="184" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="4b781ab1-11dd-4c19-9222-6d06857e7b27" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="185" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="186" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="eca8cea0-1e0c-46ad-999c-fcc22955796f" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10 ml-3" data-magicpath-id="187" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="8b9df5f6-612f-402e-b755-4595f7bcd79d" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="189" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="35c3057f-6fa6-40bf-bd83-cdae5938608e" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="190" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="138e6035-d027-4af4-9228-c4f33533c716" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="193" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Feature Panel */}
      <SortableContainer dndKitId="35dfbe48-b871-4bef-b65f-22f3ffa7f328" containerType="regular" prevTag="section" className="px-6 py-24 bg-gradient-to-b from-[#302742] via-[#38305a] to-[#43305b]" style={{
      paddingBlock: 'calc(var(--spacing)*14)'
    }} data-magicpath-id="206" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="06aa07ca-ee61-4393-a95a-8a8e797ab57f" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="207" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="891ee523-86fc-41b3-8e1d-502a01f5007e" containerType="regular" prevTag="div" className="grid lg:grid-cols-2 gap-16 items-center" data-magicpath-id="208" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="3407cce6-06a2-4f06-97d5-19c3984ec212" containerType="regular" prevTag="motion.div" className="space-y-8" initial="hidden" whileInView="show" viewport={{
            once: true,
            amount: 0.3
              ...
              <SortableContainer dndKitId="87d62874-6fe4-4ac9-92af-1f0a757e92f4" containerType="regular" prevTag="button" className="bg-gradient-to-r from-[#FF5C25] to-[#FFC542] bg-[length:200%_100%] bg-left hover:bg-right transition-all duration-300 ease-in-out px-6 py-2 rounded-full font-bold text-base lg:text-lg text-white focus:ring-2 focus:ring-yellow-400 focus:ring-offset-1 focus:outline-none" data-magicpath-id="215" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="216" data-magicpath-path="OverlaysUnoLandingPage.tsx">Learn More</span>
              </SortableContainer>
            </SortableContainer>
            <SortableContainer dndKitId="8fa9a546-8755-4af8-aefd-ac5c02b38453" containerType="regular" prevTag="motion.div" className="bg-gradient-to-b from-[#26213a]/60 to-[#302742]/40 rounded-3xl p-12 flex items-center justify-center border border-white/10" initial="hidden" whileInView="show" viewport={{
            once: true,
            amount: 0.3
          }} variants={fadeRise} data-magicpath-id="217" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="c786c7bf-2cab-4418-acb3-4ee12526af9e" containerType="regular" prevTag="div" className="text-center space-y-6" data-magicpath-id="218" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="45231751-dae6-4ec0-b3d5-90068818011a" containerType="regular" prevTag="div" className="w-24 h-24 bg-orange-500/20 rounded-2xl mx-auto flex items-center justify-center" data-magicpath-id="219" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* How It Works */}
      <SortableContainer dndKitId="fb7c1e6c-81bf-486e-94a0-6a74561b45e1" containerType="regular" prevTag="section" className="px-6 py-24 bg-gradient-to-b from-[#302742] to-[#43305b]" data-magicpath-id="223" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="ae69ed27-039c-4552-8edb-2988dae114c9" containerType="regular" prevTag="div" className="max-w-7xl mx-auto text-center" data-magicpath-id="224" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="3010bc7f-704d-472d-9dfd-b467cb3b4f73" containerType="collection" prevTag="div" className="grid md:grid-cols-3 gap-12" data-magicpath-id="229" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Pricing */}
      <SortableContainer dndKitId="97714ef1-e8a4-45bd-9fa1-61d6f7f1cb06" containerType="regular" prevTag="section" className="px-6 py-24 bg-gradient-to-b from-[#302742] to-[#43305b]" data-magicpath-id="239" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="ea07ecfb-aab6-412e-9a37-9480ba30197b" containerType="regular" prevTag="div" className="max-w-5xl mx-auto text-center" data-magicpath-id="240" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="4e1e7837-c1ba-4759-b71a-c3b0c4b1af5d" containerType="regular" prevTag="div" className="flex items-center justify-center mb-16" data-magicpath-id="245" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="66367c98-4aa2-48a7-ae7f-143a1dfebdca" containerType="regular" prevTag="div" className="bg-slate-800/50 rounded-2xl p-2 border border-slate-700/50 relative inline-flex" data-magicpath-id="246" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              {/* Slider track */}
              ...
              <SortableContainer dndKitId="6dc4c9dc-62ad-4f3a-95d7-d6ba3ca21c01" containerType="regular" prevTag="button" onClick={() => setPricingToggle('monthly')} className={`relative z-[1] px-8 py-3 rounded-xl transition-colors font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 ${pricingToggle === 'monthly' ? 'text-white' : 'text-gray-300 hover:text-white'}`} aria-pressed={pricingToggle === 'monthly'} aria-label="Select monthly pricing" data-magicpath-id="249" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="250" data-magicpath-path="OverlaysUnoLandingPage.tsx">Monthly</span>
              </SortableContainer>
              <SortableContainer dndKitId="b11ad455-4057-4181-830b-2c972e5eef96" containerType="regular" prevTag="button" onClick={() => setPricingToggle('yearly')} className={`relative z-[1] px-8 py-3 rounded-xl transition-colors font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400 ${pricingToggle === 'yearly' ? 'text-white' : 'text-gray-300 hover:text-white'}`} aria-pressed={pricingToggle === 'yearly'} aria-label="Select yearly pricing" data-magicpath-id="251" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="252" data-magicpath-path="OverlaysUnoLandingPage.tsx">Yearly</span>
              </SortableContainer>
            </SortableContainer>
          </SortableContainer>

          <SortableContainer dndKitId="30822a40-51eb-4c00-93bc-e197a8d7f73e" containerType="regular" prevTag="div" className="grid md:grid-cols-2 gap-8" data-magicpath-id="253" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            {/* Free Plan */}
            <SortableContainer dndKitId="0e0e3ac1-4008-4771-8472-ff974e402480" containerType="regular" prevTag="motion.div" className="bg-white/10 rounded-3xl p-10 border border-white/10 h-full" initial="hidden" whileInView="show" viewport={{
            once: true,
            amount: 0.25
          }} variants={fadeRise} data-magicpath-id="254" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="95701d73-e55d-4e9e-87d8-4eac7ed86a57" containerType="regular" prevTag="div" className="flex h-full flex-col" data-magicpath-id="255" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                ...
                <SortableContainer dndKitId="a5c02a09-1c1a-4abe-9777-7a90190177b2" containerType="regular" prevTag="div" className="text-5xl font-bold mb-8" data-magicpath-id="260" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <span data-magicpath-id="261" data-magicpath-path="OverlaysUnoLandingPage.tsx">$0.00</span>
                </SortableContainer>
                <SortableContainer dndKitId="496765f3-f3f9-49b4-b3c5-52ad4ab90c76" containerType="regular" prevTag="ul" className="space-y-4 mb-10 text-left" data-magicpath-id="262" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                ...
                <SortableContainer dndKitId="f328f797-572f-41bd-a5f9-7f6e2731b4a9" containerType="regular" prevTag="div" className="mt-auto" data-magicpath-id="275" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <SortableContainer dndKitId="6a4d931b-d2ff-4417-9dd1-d02e01806d59" containerType="regular" prevTag="button" className="mx-auto w-full py-4 px-6 bg-slate-900/80 backdrop-blur-sm text-white rounded-xl font-semibold text-lg text-center hover:bg-slate-800 transition-colors duration-150" data-magicpath-id="276" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            {/* Plus Plan */}
            <SortableContainer dndKitId="8290d879-0e16-4ee3-bf8c-4eed28b4d7bd" containerType="regular" prevTag="motion.div" className="bg-white/10 rounded-3xl p-10 border border-orange-500/30 relative" initial="hidden" whileInView="show" viewport={{
            once: true,
            amount: 0.25
          }} variants={fadeRise} data-magicpath-id="278" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="9133d2ca-b46a-4e9f-811d-f1e0e874ae31" containerType="regular" prevTag="div" className="flex h-full flex-col" data-magicpath-id="279" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                {pricingToggle === 'yearly' && <SortableContainer dndKitId="22db63cf-b0d0-4458-8510-503bd86c9b62" containerType="regular" prevTag="div" className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-orange-500 text-white px-6 py-2 rounded-full text-sm font-semibold" data-magicpath-id="280" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                ...
                <SortableContainer dndKitId="0b0f6476-e042-48bb-8c93-c043605f2c37" containerType="regular" prevTag="div" className="text-5xl font-bold mb-8 h-12 leading-[48px]" data-magicpath-id="286" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                ...
                <SortableContainer dndKitId="b7cc5068-e97d-4160-8147-0a072bbce5ae" containerType="regular" prevTag="ul" className="space-y-4 mb-10 text-left" data-magicpath-id="289" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                ...
                <SortableContainer dndKitId="1bb0ef06-18ec-4455-a01c-9f0af2d39d33" containerType="regular" prevTag="div" className="mt-auto" data-magicpath-id="302" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <SortableContainer dndKitId="4c094a54-d915-49c7-8e74-939870725f84" containerType="regular" prevTag="button" className="mx-auto w-full py-4 px-6 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-semibold text-lg transition-colors text-center" data-magicpath-id="303" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Stats */}
      <SortableContainer dndKitId="da5a090a-0630-4c83-80f2-7762b7e0920d" containerType="regular" prevTag="section" className="px-6 pt-24 pb-0 bg-gradient-to-b from-[#2b253e] to-[#302742]" data-magicpath-id="305" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="88187cd5-4aeb-48e1-85b0-999b9d4fcc30" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="306" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="b5ce3e0d-6f76-4f79-b946-5539e4fb7e24" containerType="regular" prevTag="div" className="relative" style={{
          minHeight: '25rem'
        }} data-magicpath-id="309" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="b8d30714-4a96-4e81-9f7d-0c68c7641675" containerType="collection" prevTag="div" className="grid gap-8 stats-grid md:grid-cols-3" data-magicpath-id="310" data-magicpath-path="OverlaysUnoLandingPage.tsx">
       ...
       {/* Community CTAs */}
       <SortableContainer dndKitId="0a1200c9-0f95-4c2a-ad36-ec68ddfcf606" containerType="regular" prevTag="section" className="px-6 pt-0 pb-24 bg-gradient-to-b from-[#302742] to-[#1F1A30]" data-magicpath-id="322" data-magicpath-path="OverlaysUnoLandingPage.tsx">
         <SortableContainer dndKitId="aef0bdd3-8aa7-4d6c-b843-1ef9992f6b8c" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="323" data-magicpath-path="OverlaysUnoLandingPage.tsx">
           ...
           <SortableContainer dndKitId="773bf524-3601-4ebe-8653-4ca9e74c2f3b" containerType="collection" prevTag="div" className="grid md:grid-cols-3 gap-8" data-magicpath-id="326" data-magicpath-path="OverlaysUnoLandingPage.tsx">
           ...
           <SortableContainer dndKitId="70066486-7d21-4442-849c-0839da649089" containerType="regular" prevTag="section" aria-labelledby="insta-subscribe-title" className="mt-12 md:mt-16 mx-auto w-full" data-magicpath-id="340" data-magicpath-path="OverlaysUnoLandingPage.tsx">
             <SortableContainer dndKitId="b9bfb8be-dd63-43f2-8067-26366009ce60" containerType="regular" prevTag="div" className="bg-white/5 border border-white/10 rounded-3xl px-4 sm:px-6 md:px-8 py-5 md:py-6" data-magicpath-id="341" data-magicpath-path="OverlaysUnoLandingPage.tsx">
               <SortableContainer dndKitId="742c5db5-9874-4d42-bbd2-0bfd69363268" containerType="regular" prevTag="header" className="mb-4" data-magicpath-id="342" data-magicpath-path="OverlaysUnoLandingPage.tsx">
               ...
               <SortableContainer dndKitId="65c2e5ad-6691-4a6e-ab07-ddc1f2b56ddc" containerType="regular" prevTag="div" className="relative" data-magicpath-id="345" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                 <SortableContainer dndKitId="d0780681-f9a2-4b54-afd2-3386eed49067" containerType="regular" prevTag="nav" className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-1" aria-label="Previous slide" data-magicpath-id="346" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                   <SortableContainer dndKitId="35e782a5-6387-4a35-b4ae-e06afaa8f50a" containerType="regular" prevTag="button" type="button" className="pointer-events-auto inline-flex h-7 w-7 items-center justify-center rounded-full bg-slate-800/80 text-white/80 ring-1 ring-white/10 transition-colors hover:text-white" aria-label="Previous" onClick={e => {
                 ...
                 <SortableContainer dndKitId="5876cc49-2051-46f7-a917-08ce2e89c92b" containerType="regular" prevTag="nav" className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-1" aria-label="Next slide" data-magicpath-id="349" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                   <SortableContainer dndKitId="237864ba-d55c-4a63-8a64-c60a93400ca9" containerType="regular" prevTag="button" type="button" className="pointer-events-auto inline-flex h-7 w-7 items-center justify-center rounded-full bg-slate-800/80 text-white/80 ring-1 ring-white/10 transition-colors hover:text-white" aria-label="Next" onClick={e => {
                  const root = e.currentTarget.closest('section') as HTMLElement | null;
                  const list = root ? root.querySelector('ul') as HTMLUListElement | null : null;
                  if (list) {
                    const tile = list.querySelector('li');
                 ...
                 <ul className="grid grid-flow-col auto-cols-[minmax(240px,1fr)] md:auto-cols-[minmax(240px,1fr)] gap-4 overflow-hidden" data-magicpath-id="352" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  ...
                  return <li key={key} className="min-w-0" data-magicpath-id="353" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                           <article className="rounded-2xl ring-1 ring-white/10 bg-gradient-to-br from-fuchsia-600 via-violet-600 to-pink-500 p-0.5" data-magicpath-id="354" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                             <SortableContainer dndKitId="e22fc5bc-bccb-4a06-96b2-a1fdc934501b" containerType="regular" prevTag="div" className="rounded-[14px] bg-gradient-to-b from-white/10 to-white/5 p-1.5" data-magicpath-id="355" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                               {/* Square tile: enforce 1:1 aspect and single row only */}
                               <SortableContainer dndKitId="d60d1114-d6a0-4813-84eb-25e69088caaf" containerType="regular" prevTag="figure" className="w-full aspect-square overflow-hidden rounded-lg" data-magicpath-id="356" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                                 ...
                                 <SortableContainer dndKitId="459b3747-32ba-496b-abe7-8783a7406300" containerType="regular" prevTag="figcaption" className="sr-only" data-magicpath-id="359" data-magicpath-path="OverlaysUnoLandingPage.tsx">
       ...
       {/* Footer */}
       <SortableContainer dndKitId="57b7d76a-4730-4a16-bf3d-bc251ffab6a6" containerType="regular" prevTag="footer" className="px-6 py-16 bg-gradient-to-b from-[#1F1A30] to-[#582864] text-white font-normal" data-magicpath-id="361" data-magicpath-path="OverlaysUnoLandingPage.tsx">
         <SortableContainer dndKitId="cc2cd73a-9535-4eff-a70f-e7f7be597185" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="362" data-magicpath-path="OverlaysUnoLandingPage.tsx">
           <SortableContainer dndKitId="e6c6810b-e18c-4946-87f8-0372601f49b3" containerType="regular" prevTag="div" className="flex flex-col items-center text-center" data-magicpath-id="363" data-magicpath-path="OverlaysUnoLandingPage.tsx">
             ...
             <SortableContainer dndKitId="e39beb5c-b55d-4907-b18d-a89440d3b576" containerType="regular" prevTag="nav" aria-label="Footer links" className="mb-4" data-magicpath-id="369" data-magicpath-path="OverlaysUnoLandingPage.tsx">
               <SortableContainer dndKitId="d0a63652-e582-4115-881d-b585da818d49" containerType="regular" prevTag="ul" className="flex items-center gap-6" data-magicpath-id="370" data-magicpath-path="OverlaysUnoLandingPage.tsx">
...
function StatNumber({
  ...
  return <SortableContainer dndKitId="04662627-43b6-49bc-a611-e0727a8b99b0" containerType="regular" prevTag="div" ref={ref} className="text-6xl font-bold text-orange-400 mb-4" data-magicpath-id="379" data-magicpath-path="OverlaysUnoLandingPage.tsx">
