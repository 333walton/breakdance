...
const overlayCategories = [{
  ...
  active: true,
  mpid: "63663165-0e15-4176-81d3-8791d6942be5"
}, {
  name: 'Browse Tools',
  active: false,
  mpid: "21492243-0e11-4938-b145-e038467bcd7e"
}] as any[];
const sportsOverlays = [{
  name: 'LPF Argentina Stadium Fly In',
  aspect: '16:9',
  mpid: "f7c6b15c-7b7c-4549-b111-382dfe94c2a6"
}, {
  name: 'Basketball Stats Overlay',
  aspect: '16:9',
  mpid: "60669267-1f81-4d25-b00b-8b5d5daf8f7c"
}, {
  name: 'Football Scoreboard Pro',
  aspect: '16:9',
  mpid: "051c76a9-b8b8-49f3-82bd-db02a978a1ee"
}, {
  name: 'Tennis Match Display',
  aspect: '16:9',
  mpid: "d330aea6-bff7-4056-8d20-e3c1af5b9641"
}, {
  name: 'Baseball Diamond View',
  aspect: '16:9',
  mpid: "5dcf2e90-a0a6-4749-beec-5e9473d6f0ea"
}, {
  name: 'Hockey Rink Layout',
  aspect: '16:9',
  mpid: "1c5c4c39-d237-4a20-943c-95d0855bd28b"
}] as any[];
const gamingOverlays = [{
  name: 'FPS Combat HUD',
  aspect: '16:9',
  mpid: "9e22afed-75ad-448c-9c1c-97dcc16e1eeb"
}, {
  name: 'RPG Interface Pro',
  aspect: '16:9',
  mpid: "665da10c-8582-4da4-b3da-bb914d9555f3"
}, {
  name: 'Racing Dashboard',
  aspect: '16:9',
  mpid: "6893231d-122e-4454-b872-16bc0c9b8c8a"
}, {
  name: 'Strategy Command',
  aspect: '16:9',
  mpid: "04f60804-0b04-470c-a026-58eed6da715f"
}, {
  name: 'Battle Royale UI',
  aspect: '16:9',
  mpid: "25bc7b26-d0ea-4bae-a994-f8957a733c13"
}, {
  name: 'Retro Arcade Style',
  aspect: '16:9',
  mpid: "90fb543c-2b00-4be0-967e-a7ff19aa7695"
}] as any[];
const podcastOverlays = [{
  name: 'Talk Show Professional',
  aspect: '16:9',
  mpid: "31d916b8-075b-4198-beed-f99601ca2795"
}, {
  name: 'Interview Setup Clean',
  aspect: '16:9',
  mpid: "83799692-1146-42da-b3bc-8628f6a8f4f3"
}, {
  name: 'News Broadcast Modern',
  aspect: '16:9',
  mpid: "38f8ed87-14e7-4111-ad51-03d003f629ee"
}, {
  name: 'Panel Discussion Layout',
  aspect: '16:9',
  mpid: "10963487-43ec-4e61-98b9-ebd2d92f72cc"
}, {
  name: 'Solo Cast Minimal',
  aspect: '16:9',
  mpid: "cfead155-9e34-4f74-be25-ed73139fa1e8"
}, {
  name: 'Live Q&A Interactive',
  aspect: '16:9',
  mpid: "9820f7a5-b08f-4888-9483-8e60e884ba4a"
}] as any[];
const howItWorksSteps = [{
  ...
  mpid: "901e27ff-7317-43ba-b6c5-bff6ca332dd0"
}, {
  icon: Palette,
  ...
  mpid: "2002f9ec-c7bb-4c49-bc7e-de4080c63834"
}, {
  icon: Copy,
  ...
  mpid: "338de5d0-8645-48ac-aef3-080721291af8"
}] as any[];
const stats = [{
  number: '19.8%',
  label: 'Higher Viewer Engagement',
  sublabel: '',
  mpid: "4be56cee-8946-4ccb-a407-3edcbb187fdf"
}, {
  number: '3.2x',
  label: 'Higher Conversion Rates',
  sublabel: '',
  mpid: "8367dbaf-6522-43fb-b775-49fc255294d8"
}, {
  number: '47%',
  label: 'Fewer Technical Issues',
  sublabel: '',
  mpid: "e00982ac-90e1-4387-a4cc-bdaebb7566b7"
}] as any[];
const communityCards = [{
  ...
  color: 'bg-indigo-600',
  mpid: "ec23e5e2-1546-4c28-b2dd-585362916551"
}, {
  icon: Youtube,
  ...
  color: 'bg-red-600',
  mpid: "e9d5cfeb-9a0a-4b5e-b61d-311f2db61f84"
}, {
  icon: Heart,
  title: 'Donate to uno',
  ...
  color: 'bg-pink-600',
  mpid: "9bf405c4-49a6-4f92-b4a5-bd8ae60e8c7b"
}] as any[];
const navigationItems = [{
  label: 'Library',
  mpid: "a4b399d7-a8dd-430d-b8ad-c93f725ab0e6"
}, {
  label: 'Tools',
  mpid: "4c96e8f9-0c9e-49c1-8704-190fbd586378"
}, {
  label: 'How It Works',
  mpid: "e94694e3-bbdf-471b-b8d8-1a03d0967a6e"
}, {
  label: 'Demo',
  mpid: "e616f578-a97d-4a13-9770-41d7a8849103"
}, {
  label: 'Live Breaks',
  mpid: "f63bada5-ac3c-48c0-90ed-34b9e470a499"
}, {
  label: 'Shop',
  mpid: "d1d5be3b-8fc1-48f7-b339-2c9c1b6b3c33"
}, {
  label: 'About',
  mpid: "7b6602b8-7333-413a-b937-ad7699da66e4"
}] as any[];
...
export const OverlaysUnoLandingPage = () => {
  ...
  const dotContent = [{
    ...
    mpid: "feb904fc-53fd-4e14-97a9-657c2249e440"
  }, {
    id: 'dot-2',
    ...
    mpid: "7b361412-8365-4bac-98c6-20a78bceb8bc"
  }, {
    id: 'dot-3',
    ...
    mpid: "d62f6e78-3ea5-4400-a8a4-d5ef656ff72e"
  }] as const;
  ...
  const LayeredHeroButtons = () => {
    const cards = [{
      ...
      label: 'Form Window',
      z: 1,
      mpid: "d58a9246-b51e-458c-91d3-7f7465bffb66"
    }, {
      id: 'nfl-grid',
      label: 'NFL Grid',
      z: 2,
      mpid: "71b6fd41-7c77-436a-9be6-4c045293eefc"
    }, {
      id: 'phone-preview',
      label: 'Phone Preview',
      z: 3,
      mpid: "e402d0e5-c599-4395-b651-bbe5abd456a5"
    }] as any[];
    ...
    return <SortableContainer dndKitId="95db383b-b628-4404-a33c-25af625e4896" containerType="regular" prevTag="div" className="relative w-full h-full" data-magicpath-id="0" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        {/* Back layer – Browser Button */}
        <SortableContainer dndKitId="d6e0986a-83f6-4b23-ab03-5b8858e83c72" containerType="regular" prevTag="button" type="button" aria-label="Open form window" onClick={() => setSelectedHero('form')} className={`${baseStyles} form-window`} style={{
        ...
        transformStyle: 'preserve-3d'
          ...
          <SortableContainer dndKitId="d2e9bc8a-92b0-41cf-ac46-45fb84e2a063" containerType="regular" prevTag="div" className="w-full h-full rounded-2xl bg-slate-900/80 border border-white/10 overflow-hidden" data-magicpath-id="2" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="945f3a41-cc99-411d-8a74-a11c6b30c331" containerType="regular" prevTag="div" className="flex items-center gap-2 px-4 py-2 border-b border-white/10" data-magicpath-id="3" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        ...
        <SortableContainer dndKitId="fb7f54fe-c3b0-4c94-b18c-646fa3a3c53a" containerType="regular" prevTag="button" type="button" aria-label="Open NFL grid" onClick={() => setSelectedHero('nfl')} className={`${baseStyles} nfl-grid`} style={{
        ...
        <SortableContainer dndKitId="51470c04-a617-4dd3-96a3-de533824a91c" containerType="regular" prevTag="button" type="button" aria-label="Open phone preview" onClick={() => setSelectedHero('phone')} className={`${baseStyles} phone-preview`} style={{
        ...
        height: '72%'
          ...
          <SortableContainer dndKitId="0937213f-faea-422d-8aea-eaf7ea7bcd0a" containerType="regular" prevTag="div" className="relative w-full h-full rounded-[14px] bg-black border border-white/20 p-2 shadow-[0_22px_60px_rgba(0,0,0,0.55)]" data-magicpath-id="12" data-magicpath-path="OverlaysUnoLandingPage.tsx">
  ...
  // @return
  return <SortableContainer dndKitId="5d607b32-a925-4158-9ac2-5bb2cb6e6e29" containerType="regular" prevTag="div" className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-900 to-blue-950 text-white font-sans" data-magicpath-id="19" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      {/* Header */}
      <SortableContainer dndKitId="d3d96647-0672-4e5a-bbc2-d08e52efa4d0" containerType="regular" prevTag="header" className="bg-slate-900/80 backdrop-blur-sm border-b border-orange-500/30 sticky top-0 z-50 flex flex-col md:flex-row items-center justify-between" data-magicpath-id="20" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="98f485a9-4bfe-4a14-a40d-93209264b80a" containerType="regular" prevTag="div" className="w-full max-w-screen-xl mx-auto px-4 py-4" data-magicpath-id="21" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="0419a10c-6364-44fc-8d57-136d8955667c" containerType="regular" prevTag="div" className="flex flex-col md:flex-row items-center justify-between w-full" data-magicpath-id="22" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            {/* Logo */}
            <SortableContainer dndKitId="aa9c4086-b228-4bd5-b3a7-235065c2997a" containerType="regular" prevTag="div" className="text-2xl font-bold" data-magicpath-id="23" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            {/* Navigation */}
            <SortableContainer dndKitId="74e759fc-99c1-4358-a6a1-ae67107aecf5" containerType="collection" prevTag="nav" className="hidden md:flex items-center space-x-8 -ml-8 lg:-ml-64" data-magicpath-id="26" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            {/* Auth & Discord */}
            <SortableContainer dndKitId="ea479862-5ba3-4448-bf3b-af84c10c6e3e" containerType="regular" prevTag="div" className="flex items-center space-x-3" data-magicpath-id="30" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="76c75c97-aa59-428e-a63d-a10aa5fc9406" containerType="regular" prevTag="button" className="px-4 py-2 text-white border border-white rounded-full text-sm font-medium transition-colors duration-150 ease-out hover:bg-white hover:text-slate-900" data-magicpath-id="31" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="32" data-magicpath-path="OverlaysUnoLandingPage.tsx">Sign up</span>
              </SortableContainer>
              <SortableContainer dndKitId="e4d5fc94-4918-4e16-ba76-325d51746cc0" containerType="regular" prevTag="button" className="px-4 py-2 text-white border border-white rounded-full text-sm font-medium transition-colors duration-150 ease-out hover:bg-white hover:text-slate-900" data-magicpath-id="33" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="34" data-magicpath-path="OverlaysUnoLandingPage.tsx">Login</span>
              </SortableContainer>
              <SortableContainer dndKitId="f1dc240a-38b2-474b-a0b7-ef690414c7ec" containerType="regular" prevTag="button" className="px-4 py-2 bg-[#FFC543] text-slate-900 border rounded-full text-sm font-medium transition-colors duration-150 ease-out hover:bg-white hover:text-[#FFC543] hover:border-white flex items-center space-x-2" data-magicpath-id="35" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Hero Section */}
      <SortableContainer dndKitId="bb8d8507-2328-43a6-b41b-ab6b9dd58a01" containerType="regular" prevTag="section" className="px-6 py-14" data-magicpath-id="38" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="9dbf55d5-e608-4ea9-825f-4b9dd40de90c" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="39" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="54d83d0d-e89e-47cd-acae-e5e85990debb" containerType="regular" prevTag="div" className="grid lg:grid-cols-2 gap-16 items-center" data-magicpath-id="40" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="b7acfebc-bebd-4862-be15-e6b3e39a529d" containerType="regular" prevTag="motion.div" initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            duration: 0.8
              ...
              <SortableContainer dndKitId="388a6a14-0969-4375-a1e2-c4342af3dc0a" containerType="regular" prevTag="motion.button" className="bg-gradient-to-r from-[#FF5C25] to-[#FFC542] bg-[length:200%_100%] bg-left hover:bg-right transition-all duration-300 ease-in-out px-10 py-4 rounded-full font-bold text-lg text-white focus:ring-2 focus:ring-yellow-400 focus:ring-offset-1 focus:outline-none shadow-lg" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            ...
            <SortableContainer dndKitId="dc0bd900-f790-45e1-b182-3c5ef9175c34" containerType="regular" prevTag="motion.div" className="relative" initial={{
            opacity: 0,
            x: 30
          }} animate={{
            opacity: 1,
            ...
            delay: 0.2
              ...
              <SortableContainer dndKitId="58782cd5-db41-4947-a1e2-1f79ce3a580b" containerType="regular" prevTag="div" className="relative w-full h-full" data-magicpath-id="50" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="85850aee-ce10-4845-9819-760e0f0f1747" containerType="regular" prevTag="div" className="relative w-full h-[420px] sm:h-[460px] md:h-[500px] lg:h-[520px] xl:h-[560px] rounded-3xl bg-gradient-to-br from-white/5 to-white/0 border border-white/10 p-6 sm:p-8" style={{
                perspective: 1200
              }} data-magicpath-id="51" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <SortableContainer dndKitId="2f000120-c68c-407a-a3b8-478eb7f2b9b6" containerType="regular" prevTag="div" className="relative w-full h-full" data-magicpath-id="52" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="74749e41-0a91-4224-9545-3680a9edd84c" containerType="regular" prevTag="nav" aria-label="Hero pagination" className="mt-14 translate-y-5 flex items-center justify-center" data-magicpath-id="54" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="c52108e0-14e9-45f6-a2d7-3a52e982a3c8" containerType="collection" prevTag="ul" className="flex items-center gap-x-4" style={{
            display: "none"
      ...
      <SortableContainer dndKitId="0b5e480d-1798-4b92-aa71-cb2a2cf86062" containerType="regular" prevTag="section" className="px-6 pt-12 pb-0 bg-black/20" data-magicpath-id="59" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="9509d152-179c-42a5-9164-ebbca7598c4c" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="60" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="788b92ee-ec54-4a58-a009-a4b7cca818f4" containerType="collection" prevTag="div" className="flex space-x-4 overflow-x-auto scrollbar-hide justify-center no-scrollbar snap-x snap-mandatory" data-magicpath-id="61" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="23cb9e87-f851-4521-89fc-de10dde738b1" containerType="regular" prevTag="section" className={`px-6 py-5 bg-black/20 ${activeCategory === 'Browse Tools' ? 'hidden' : ''}`} data-magicpath-id="65" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="0f8d866c-ff53-437a-b1f4-010b3879f2cc" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="66" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="89c68953-72dc-4a49-9cef-61bcf7f6176f" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="67" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="c141f541-955c-4d22-a12b-2e091b6c25bb" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="70" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="4b1e598a-94c3-47c9-abde-03441c3f794a" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="71" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="fdfbbd8b-1137-43f7-b40c-40e4de4b14d2" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="72" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="73" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="a3569241-ec83-4237-bff8-3deafb9d450e" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="74" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronRight className="w-5 h-5" data-magicpath-id="75" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
              </SortableContainer>
              <SortableContainer dndKitId="55ff89b2-b6b4-43b7-8680-511386f40cf7" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-5" data-magicpath-id="76" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="d15901d4-774f-471e-abb3-4e43df476908" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="79" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="172b2007-0c10-40e6-a9b4-3bfb3f04a364" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="80" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="c1f29456-69d2-48ef-b39c-90b0c9f5f006" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="83" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="0ba6b663-1ee0-490e-8cff-17bb474f085e" containerType="regular" prevTag="section" className={`px-6 py-5 bg-black/20 ${activeCategory === 'Browse Tools' ? 'hidden' : ''}`} style={{
      paddingTop: 'calc(var(--spacing)*0)'
    }} data-magicpath-id="95" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="94fef9c0-1a57-422e-93fc-9845e35b1afc" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="96" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="1bc8b579-1c01-4096-a968-f95944e0628b" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="97" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="b7af7628-43a3-4061-b2a6-e660afe24b3e" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="100" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="61b66270-b123-40e9-9bbd-a05b3829cb69" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="101" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="89c5c3bc-20d3-4cac-a9d3-046deb29e068" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="102" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="103" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="d3a994ac-4ee6-416b-85e9-71c6c2461971" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="104" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronRight className="w-5 h-5" data-magicpath-id="105" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
              </SortableContainer>
              <SortableContainer dndKitId="a1f3810c-83b7-4d0c-8840-26a9cb7beeb6" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-5" data-magicpath-id="106" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="189ef3ff-d0a2-4249-b0bb-011a9befa5fe" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="109" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="d87ab16f-05b0-402c-a35f-800c5595bad5" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="110" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="43210185-5442-471c-83c4-b17f4c5a30eb" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="113" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="e27621a4-e072-45bf-b615-99f35d70d658" containerType="regular" prevTag="section" className={`px-6 py-5 bg-black/20 ${activeCategory === 'Browse Tools' ? 'hidden' : ''}`} style={{
      paddingBottom: 'calc(var(--spacing)*14)',
      paddingTop: 'calc(var(--spacing)*0)'
    }} data-magicpath-id="125" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="c77c9581-62fe-40f1-a85c-4ab8a5481224" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="126" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="fd2b7771-caaa-463d-86ff-e07e214cc6fc" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="127" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="a10abe3c-521b-4d78-80b7-2a8279a932d7" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="130" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="96b3e6df-9362-4e61-82c4-6243243aa370" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="131" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="efb4a987-5870-41cb-b1d8-85375d1e3bd9" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="132" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="133" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="f63cceac-9ece-46b8-b4a1-d12e233f4285" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="134" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronRight className="w-5 h-5" data-magicpath-id="135" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
              </SortableContainer>
              <SortableContainer dndKitId="0d0cb463-d36e-4e12-a3dc-421731bfb00d" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-5" data-magicpath-id="136" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="0ef15d00-9111-4d10-a4c3-6ce317048388" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="139" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="a84a8d00-91ac-4b17-ac39-8bbc8fbd2941" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="140" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="f4dc2592-2e46-4aa9-aa66-7ea8a0b14ce4" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="143" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      <SortableContainer dndKitId="248d820f-588c-4f41-94fc-cd6f0fa50d4c" containerType="regular" prevTag="section" className={`px-6 py-5 bg-black/20 ${activeCategory === 'Browse Tools' ? '' : 'hidden'}`} style={{
      paddingBottom: 'calc(var(--spacing)*14)'
    }} data-magicpath-id="155" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="756cbf1f-c5b2-4a86-aacb-1ba0549a6e5c" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="156" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="96ffa813-01ef-4f95-9f84-57ad374b3a5a" containerType="regular" prevTag="div" className="flex items-center justify-between mb-0" data-magicpath-id="157" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="9772354f-5261-4889-aeb3-eef5083126fb" containerType="regular" prevTag="div" className="flex items-center" data-magicpath-id="160" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="8e8981e0-f047-475c-9c47-83f0fc9c4e9f" containerType="regular" prevTag="div" className="hidden" data-magicpath-id="161" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="6d99f779-c61d-40af-9c62-e4df2aac9892" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10" data-magicpath-id="162" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                  <ChevronLeft className="w-5 h-5" data-magicpath-id="163" data-magicpath-path="OverlaysUnoLandingPage.tsx" />
                </SortableContainer>
                <SortableContainer dndKitId="c51a4c1c-3e5f-4805-93bc-11b446690585" containerType="regular" prevTag="button" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/10 ml-3" data-magicpath-id="164" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="ce6bbe79-f5d2-4b2e-8784-0b41a81bf41f" containerType="regular" prevTag="div" className="flex justify-end" data-magicpath-id="166" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="591a5f65-b33e-4033-ba57-39f5c21bda9d" containerType="regular" prevTag="button" className="text-orange-400 hover:text-orange-300 flex items-center space-x-2 transition-colors duration-200 font-medium mb-2" data-magicpath-id="167" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="da282489-d228-4011-8d2a-e0e7bbd2dd91" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" data-magicpath-id="170" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Feature Panel */}
      <SortableContainer dndKitId="582866a0-a4bb-4b3e-9703-a9ab4c9809f6" containerType="regular" prevTag="section" className="px-6 py-24" style={{
      paddingBlock: 'calc(var(--spacing)*14)'
    }} data-magicpath-id="183" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="5c0e3348-00e5-465c-81f6-220bac51a404" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="184" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="9b4b6581-83d3-43b4-b9b0-b02882538087" containerType="regular" prevTag="div" className="grid lg:grid-cols-2 gap-16 items-center" data-magicpath-id="185" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="76ebd9a4-2a34-4678-a9d8-561aae4e37f1" containerType="regular" prevTag="div" className="space-y-8" data-magicpath-id="186" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="527d53f0-fae9-466a-9cf6-8e8e728d4137" containerType="regular" prevTag="button" className="bg-gradient-to-r from-[#FF5C25] to-[#FFC542] bg-[length:200%_100%] bg-left hover:bg-right transition-all duration-300 ease-in-out px-6 py-2 rounded-full font-bold text-base lg:text-lg text-white focus:ring-2 focus:ring-yellow-400 focus:ring-offset-1 focus:outline-none" data-magicpath-id="192" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="193" data-magicpath-path="OverlaysUnoLandingPage.tsx">Learn More</span>
              </SortableContainer>
            </SortableContainer>
            <SortableContainer dndKitId="291d75d0-933d-432c-87dd-382c018e80a3" containerType="regular" prevTag="div" className="bg-gradient-to-br from-purple-800/20 to-blue-800/20 rounded-3xl p-12 flex items-center justify-center border border-white/10" data-magicpath-id="194" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="3c3eb764-7edd-49e7-9f89-47b70cf50fe0" containerType="regular" prevTag="div" className="text-center space-y-6" data-magicpath-id="195" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <SortableContainer dndKitId="22e36ca7-2913-4808-bd34-197c50321ef2" containerType="regular" prevTag="div" className="w-24 h-24 bg-orange-500/20 rounded-2xl mx-auto flex items-center justify-center" data-magicpath-id="196" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* How It Works */}
      <SortableContainer dndKitId="c3a13e4c-91cf-4254-a9c4-dbb799709dc5" containerType="regular" prevTag="section" className="px-6 py-24 bg-black/20" data-magicpath-id="200" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="cfb70091-534f-44e6-b3d6-ccfc09ac95a1" containerType="regular" prevTag="div" className="max-w-7xl mx-auto text-center" data-magicpath-id="201" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="79b26857-76b0-4077-b177-eec53c282b1f" containerType="collection" prevTag="div" className="grid md:grid-cols-3 gap-12" data-magicpath-id="206" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Pricing */}
      <SortableContainer dndKitId="15375faf-3f8c-4473-a567-ced3855e0315" containerType="regular" prevTag="section" className="px-6 py-24" data-magicpath-id="216" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="5012698b-ee42-4a05-85a4-b4e9ca755006" containerType="regular" prevTag="div" className="max-w-5xl mx-auto text-center" data-magicpath-id="217" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="cfbe0686-e364-4e38-8f40-b9a4efb7abc9" containerType="regular" prevTag="div" className="flex items-center justify-center mb-16" data-magicpath-id="222" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="96b4ca33-97aa-4218-95af-581320bbfc9c" containerType="regular" prevTag="div" className="bg-slate-800/50 rounded-xl p-2 border border-slate-700/50" data-magicpath-id="223" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              <SortableContainer dndKitId="880c0eef-d6c6-4ca9-976c-8577a9a37545" containerType="regular" prevTag="button" onClick={() => setPricingToggle('monthly')} className={`px-8 py-3 rounded-lg transition-all font-medium ${pricingToggle === 'monthly' ? 'bg-orange-500 text-white shadow-lg' : 'text-gray-300 hover:text-white'}`} data-magicpath-id="224" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="225" data-magicpath-path="OverlaysUnoLandingPage.tsx">Monthly</span>
              </SortableContainer>
              <SortableContainer dndKitId="a8115287-4ced-4d95-89a9-e88f02c5666a" containerType="regular" prevTag="button" onClick={() => setPricingToggle('yearly')} className={`px-8 py-3 rounded-lg transition-all font-medium ${pricingToggle === 'yearly' ? 'bg-orange-500 text-white shadow-lg' : 'text-gray-300 hover:text-white'}`} data-magicpath-id="226" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="227" data-magicpath-path="OverlaysUnoLandingPage.tsx">Yearly</span>
              </SortableContainer>
            </SortableContainer>
          </SortableContainer>

          <SortableContainer dndKitId="58f27471-2b79-4048-8930-7374b228c8b7" containerType="regular" prevTag="div" className="grid md:grid-cols-2 gap-8" data-magicpath-id="228" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            {/* Free Plan */}
            <SortableContainer dndKitId="871cf4a4-fc4c-4023-aa5a-22eab3198629" containerType="regular" prevTag="div" className="bg-white/10 rounded-3xl p-10 border border-white/10" data-magicpath-id="229" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="5d711ae5-7e1b-4d07-983e-fd65ea16eac6" containerType="regular" prevTag="div" className="text-5xl font-bold mb-8" data-magicpath-id="234" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="235" data-magicpath-path="OverlaysUnoLandingPage.tsx">$0.00</span>
              </SortableContainer>
              <SortableContainer dndKitId="b213d821-84af-4230-8bc0-ec18ab7dc9b3" containerType="regular" prevTag="ul" className="space-y-4 mb-10 text-left" data-magicpath-id="236" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="173043fc-5e45-4302-b86a-9592dd24d4ac" containerType="regular" prevTag="button" className="w-full py-4 bg-slate-600 text-gray-300 rounded-xl font-semibold text-lg" data-magicpath-id="249" data-magicpath-path="OverlaysUnoLandingPage.tsx">
                <span data-magicpath-id="250" data-magicpath-path="OverlaysUnoLandingPage.tsx">Current Plan</span>
              </SortableContainer>
            </SortableContainer>

            {/* Plus Plan */}
            <SortableContainer dndKitId="0e9afd49-eef3-46e6-ac68-a1b85814bb99" containerType="regular" prevTag="div" className="bg-white/10 rounded-3xl p-10 border border-orange-500/30 relative" data-magicpath-id="251" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              {pricingToggle === 'yearly' && <SortableContainer dndKitId="5707d263-93a4-4604-b0eb-d19a1dcc4fd9" containerType="regular" prevTag="div" className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-orange-500 text-white px-6 py-2 rounded-full text-sm font-semibold" data-magicpath-id="252" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="61b34945-7939-4fc8-9f52-73459022ae27" containerType="regular" prevTag="div" className="text-5xl font-bold mb-8" data-magicpath-id="258" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="fd3dc31b-800d-4435-bc4d-bbb5e3d894af" containerType="regular" prevTag="ul" className="space-y-4 mb-10 text-left" data-magicpath-id="261" data-magicpath-path="OverlaysUnoLandingPage.tsx">
              ...
              <SortableContainer dndKitId="8b5dcf8c-a532-45de-a1ab-8dc7eee0563e" containerType="regular" prevTag="button" className="w-full py-4 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-semibold text-lg transition-colors" data-magicpath-id="274" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Stats */}
      <SortableContainer dndKitId="82670c3a-f792-4320-8a5a-6b6db7a36819" containerType="regular" prevTag="section" className="px-6 py-24 bg-black/20" data-magicpath-id="276" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="aa3a0135-3cb9-4b3e-8b89-41720f32301e" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="277" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="94c7a4a6-5e07-4dd3-ac01-c1a3805cb660" containerType="collection" prevTag="div" className="grid md:grid-cols-3 gap-8" onMouseLeave={e => {
      ...
      {/* Community CTAs */}
      <SortableContainer dndKitId="95954f1b-178c-4ce6-906e-537c38957ada" containerType="regular" prevTag="section" className="px-6 py-24" data-magicpath-id="292" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="67eaf405-b630-4746-9516-02bdb4e4e6f6" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="293" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          ...
          <SortableContainer dndKitId="39b8ef8e-56d8-44f5-b300-74861e1aefef" containerType="collection" prevTag="div" className="grid md:grid-cols-3 gap-8" data-magicpath-id="296" data-magicpath-path="OverlaysUnoLandingPage.tsx">
      ...
      {/* Footer */}
      <SortableContainer dndKitId="26cb98fc-4978-4e95-beb8-e484408459b8" containerType="regular" prevTag="footer" className="px-6 py-16" data-magicpath-id="306" data-magicpath-path="OverlaysUnoLandingPage.tsx">
        <SortableContainer dndKitId="0546b8b6-2577-4f17-bc36-6d0963340fe5" containerType="regular" prevTag="div" className="max-w-7xl mx-auto" data-magicpath-id="307" data-magicpath-path="OverlaysUnoLandingPage.tsx">
          <SortableContainer dndKitId="8670cafc-c6d3-4914-9b11-44473dc55888" containerType="regular" prevTag="div" className="flex items-center justify-between" data-magicpath-id="308" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            <SortableContainer dndKitId="7712a0fa-5859-4cd9-b48f-d672a62753a8" containerType="regular" prevTag="div" className="text-2xl font-bold" data-magicpath-id="309" data-magicpath-path="OverlaysUnoLandingPage.tsx">
            ...
            <SortableContainer dndKitId="4bf2786b-bb15-4d44-8c08-aae898ab87a6" containerType="regular" prevTag="div" className="flex items-center space-x-8" data-magicpath-id="312" data-magicpath-path="OverlaysUnoLandingPage.tsx">
